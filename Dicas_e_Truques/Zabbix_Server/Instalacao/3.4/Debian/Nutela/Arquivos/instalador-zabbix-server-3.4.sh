...
# Zabbix link
zabbixDownloadLink="https://raw.githubusercontent.com/MagnoMonteCerqueira/Zabbix/master/Dicas_e_Truques/Zabbix_Server/Instalacao/3.4/Debian/Nutela/Arquivos/zabbix-3.4.2.tar.gz"
...
INTEGRA ()
{
	...
	case $ID in
		...
		centos)
			chown apache $zabbixFrontend/conf/igz.conf.php
		;;
...
END_MSG ()
{
	...
	whiptail --title "${TITULO}" --backtitle "${BANNER}" --msgbox "
		...
		Username & Password access the system => Admin/zabbix
