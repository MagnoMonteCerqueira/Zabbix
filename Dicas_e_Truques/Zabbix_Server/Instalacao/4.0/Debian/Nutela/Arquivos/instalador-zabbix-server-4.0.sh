...
zabbixVersion="Zabbix Server 4.0"
...
# Zabbix link
zabbixDownloadLink="https://raw.githubusercontent.com/MagnoMonteCerqueira/Zabbix/master/Dicas_e_Truques/Zabbix_Server/Instalacao/4.0/Debian/Nutela/Arquivos/zabbix-4.0.3.tar.gz"
...
MAIN_MENU ()
{
	...
	"1" "Zabbix Server 4.0 + Verdanatech iGZ" \
	"2" "About" \
	"3" "Exit" 3>&1 1>&2 2>&3)
